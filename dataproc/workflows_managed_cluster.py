...
# This sample walks a user through creating a workflow with a managed cluser 
...
def instantiate_inline_workflow_managed_cluster(project_id, region):
    """This sample walks a user through submitting a workflow with a managed cluster 
